...
run_program() {
  ...
  # For macOS
  #gcc -std=c11 main_RMB_pure.c func.c mt19937ar.c -I/opt/homebrew/opt/openblas/include/ -L/opt/homebrew/opt/openblas/lib -Wl,-rpath,/opt/homebrew/opt/openblas/lib -lopenblas -lm -o "${output_executable}"

  # For Linux
  gcc -std=c11 main_RMB_pure.c func.c mt19937ar.c -Wl,-z,muldefs -llapacke -llapack -lopenblas -lm -o "${output_executable}"
...
# Values for L.
L_values=(100000)
#L_values=(10 100 1000 10000 100000)
